...
public class DiscussgeshouxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discussgeshouxinxi,deSens);
    ...
    public R save(@RequestBody DiscussgeshouxinxiEntity discussgeshouxinxi, HttpServletRequest request){
        ...
        return R.ok().put("data",discussgeshouxinxi.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscussgeshouxinxiEntity discussgeshouxinxi = discussgeshouxinxiService.selectOne(new EntityWrapper<DiscussgeshouxinxiEntity>().eq("", username));
        return R.ok().put("data", discussgeshouxinxi);
    }
    ...
    public R update(@RequestBody DiscussgeshouxinxiEntity discussgeshouxinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussgeshouxinxi);
        //全部更新
        discussgeshouxinxiService.updateById(discussgeshouxinxi);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussgeshouxinxiEntity discussgeshouxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussgeshouxinxiEntity> ew = new EntityWrapper<DiscussgeshouxinxiEntity>();
