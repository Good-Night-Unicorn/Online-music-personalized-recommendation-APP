...
public class DiscussgequxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discussgequxinxi,deSens);
    ...
    public R save(@RequestBody DiscussgequxinxiEntity discussgequxinxi, HttpServletRequest request){
        ...
        return R.ok().put("data",discussgequxinxi.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscussgequxinxiEntity discussgequxinxi = discussgequxinxiService.selectOne(new EntityWrapper<DiscussgequxinxiEntity>().eq("", username));
        return R.ok().put("data", discussgequxinxi);
    }
    ...
    public R update(@RequestBody DiscussgequxinxiEntity discussgequxinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussgequxinxi);
        //全部更新
        discussgequxinxiService.updateById(discussgequxinxi);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussgequxinxiEntity discussgequxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussgequxinxiEntity> ew = new EntityWrapper<DiscussgequxinxiEntity>();
