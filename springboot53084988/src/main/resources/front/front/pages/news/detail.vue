	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#f8f8f8","height":"auto"}'>
			<view :style='{"alignContent":"flex-start","padding":"24rpx","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				...
				<view :style='{"width":"100%","margin":"24rpx 0 24rpx 0","justifyContent":"center","display":"flex","order":"2"}'>
					<view :style='{"padding":"0 20rpx","margin":"0 20rpx 0 0","borderRadius":"60rpx","color":"#fff","background":"#23baf7","display":"flex","width":"auto","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					...
					<view :style='{"padding":"0 20rpx","margin":"0","borderRadius":"60rpx","color":"#fff","background":"#23baf7","display":"flex","width":"auto","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
						<view :style='{"padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"inherit","color":"inherit","textAlign":"right"}' class="lable">取消赞</view>
						<view :style='{"color":"inherit","lineHeight":"80rpx","fontSize":"inherit"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"margin":" 0 0 0 10rpx","lineHeight":"80rpx","fontSize":"inherit","color":"inherit"}' class="icon iconfont icon-zan10"></view>
					</view>
					<view :style='{"padding":"0 20rpx","margin":"0","borderRadius":"60rpx","color":"#666","background":"#b7c7ce","display":"flex","width":"auto","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
					...
					<view :style='{"padding":"0 20rpx","margin":"0","borderRadius":"60rpx","color":"#666","background":"#b7c7ce","display":"flex","width":"auto","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"40rpx auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"3"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0","background":"#ae4341","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"8"}' v-if="userid&&isAuth('news','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0","background":"#ae4341","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"8"}' v-if="!userid&&isAuthFront('news','私聊')" @tap="chatClick">联系TA</button>
