				...
				<view :style='{"width":"100%","background":"none","height":"auto"}'>
					<view class="uni-product-list" :style='{"padding":"40rpx 0 0","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"padding":"12rpx 10rpx","margin":"0 0 40rpx","backgroundColor":"#fff","borderRadius":"12rpx","flexWrap":"wrap","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
							...
							<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"12rpx","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-if="product.tablename.substr(0,7)=='chapter'" src="/static/chapter.jpg"></image>
							<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"12rpx","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-else-if="preHttp(product.picture)" :src="product.picture"></image>
							<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"12rpx","display":"block","width":"100%","height":"240rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-else :src="baseUrl+product.picture"></image>
						</view>
					</view>
