	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="歌曲分类" prop="gequfenlei" >
			...
			<el-form-item v-else-if="ruleForm.geci" label="歌词" prop="geci" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.geci"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.geci = this.ruleForm.geci.replace(reg,'../../../springboot53084988/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
