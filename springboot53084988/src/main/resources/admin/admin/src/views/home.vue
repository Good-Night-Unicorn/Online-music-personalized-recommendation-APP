	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'gequxinxiChart1',css:'animate__'},
				{id:'gequxinxiChart2',css:'animate__'},
				{id:'gequxinxiChart3',css:'animate__'},
			]
	...
	.home-content {
		...
		.statis-box {
			...
			.statis1 {
				...
				.left {
					border-radius: 0;
					background: url(http://codegen.caihongy.cn/20240925/b2b2e7296fde4d4ca45828d19ab2f87b.png) no-repeat center center / 100%;
					display: flex;
					width: 30%;
					justify-content: center;
					align-items: center;
