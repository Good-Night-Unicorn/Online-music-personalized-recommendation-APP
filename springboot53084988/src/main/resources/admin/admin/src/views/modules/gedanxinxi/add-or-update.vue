	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.chuangjianriqi" label="创建日期" prop="chuangjianriqi" >
					<el-input v-model="ruleForm.chuangjianriqi" placeholder="创建日期" readonly></el-input>
				</el-form-item>
			</template>
			...
			<el-form-item v-else-if="ruleForm.miaoshu" label="描述" prop="miaoshu" >
				<span class="text">{{ruleForm.miaoshu}}</span>
			</el-form-item>
