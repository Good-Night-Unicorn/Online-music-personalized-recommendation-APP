<template>
	<view :style='{"minHeight":"100vh","width":"100%","padding":"24rpx","position":"relative","background":"#f8f8f8","height":"auto"}'>
		...
		<div :style='{"padding":"0","margin":"0px auto","borderRadius":"0 0 20rpx 20rpx","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		  <div @click="prepDetailClick" :style='{"color":"#666","borderRadius":"0 0 0 20rpx","textAlign":"center","background":"#b7c7ce","width":"50%","lineHeight":"80rpx","fontSize":"28rpx"}'>上一篇：prev</div>
		  <div @click="nextDetailClick" :style='{"color":"#fff","borderRadius":"0 0 20rpx 0","textAlign":"center","background":"#23baf7","width":"50%","lineHeight":"80rpx","fontSize":"28rpx"}'>下一篇：next</div>
		</div>
		

		<!-- 热门 -->
		<view class="hot" :style='{"width":"100%","margin":"40rpx 0 0 0","background":"none","height":"auto"}'>
		  <view :style='{"padding":"0 0 0 20rpx","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#23baf7","textAlign":"left","background":"none","borderWidth":"0 0 0 12rpx","width":"100%","fontSize":"40rpx","borderStyle":"solid","fontWeight":"600"}'>热门信息</view>
		  <view :style='{"padding":"20rpx 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in hotList" :key="index" :style='{"width":"48%","padding":"20rpx","margin":"0 0 40rpx","borderRadius":"20rpx","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
			  <image :style='{"width":"100%","margin":"0 0 10rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"200rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
		...
		<view class="recommend" :style='{"width":"100%","background":"none","display":"block","height":"auto"}'>
		  <view :style='{"padding":"0 0 0 20rpx","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#23baf7","textAlign":"left","background":"none","borderWidth":"0 0 0 12rpx","width":"100%","fontSize":"40rpx","borderStyle":"solid","fontWeight":"600"}'>推荐信息</view>
