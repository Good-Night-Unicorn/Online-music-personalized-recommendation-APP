		...
		<view class="content">
			<view :style='{"minHeight":"100vh","width":"100%","padding":"0 24rpx 48rpx","position":"relative","background":"url(http://codegen.caihongy.cn/20241029/d192bff62bc241578876b935312772da.png) no-repeat center top / 100% auto,#f8f8f8","height":"auto"}'>
				...
				<view :style='{"width":"100%","background":"none","height":"auto"}'>
					...
					<!-- 样式1 -->
					<view class="news-box1" :style='{"width":"100%","padding":"24rpx","margin":"40rpx auto","background":"#fff","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"minHeight":"172rpx","padding":"0","margin":"0 0 20rpx","flexWrap":"wrap","background":"#f6f8ff","display":"block","width":"100%","position":"relative","height":"auto"}'>
							<view class="list-item-body" :style='{"width":"100%","padding":"20rpx 0 0 200rpx","margin":"0","height":"auto"}'>
								...
								<view :style='{"padding":"0 0px","overflow":"hidden","whiteSpace":"nowrap","color":"#666","width":"100%","lineHeight":"1.5","fontSize":"28rpx","textOverflow":"ellipsis"}' class="text ">{{product.introduction}}</view>
								<view :style='{"padding":"0 20rpx","alignItems":"center","color":"#fff","textAlign":"center","display":"flex","justifyContent":"center","top":"20rpx","left":"20rpx","background":"#23baf7","width":"160rpx","fontSize":"32rpx","position":"absolute","height":"130rpx"}'>
									<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","display":"none"}'></text>
